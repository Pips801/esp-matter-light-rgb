                                      ...
                                      uint32_t attribute_id, esp_matter_attr_val_t *val)
{
    ...
    if (endpoint_id == light_endpoint_id) {
        ...
        ESP_LOGI(TAG, "Attribute updated. Cluster: %d, Attribute: %d, Value: %d", cluster_id, attribute_id, val);
        ...
        } else if (cluster_id == TemperatureControl::Id) {
...
app_driver_handle_t app_driver_temp_init()
{
    /* Initialize temp sensor */
    /* TODO: finish init handler */
    temperature_sensor_config_t config = { .range_min = 20, .range_max = 125 };
